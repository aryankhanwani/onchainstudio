...
const HoverVideoPlayerPlayPauseButton: React.FC = () => {
  ...
  return (
    <button
      onClick={togglePlay}
      className="p-2 text-white hover:text-white/80 transition-colors rounded-md hover:bg-white/10"
...
const HoverVideoPlayerProgressBar: React.FC = () => {
  ...
  return (
    <input
      type="range"
      className="mt-2 w-full h-1 bg-white/20 rounded-lg appearance-none cursor-pointer accent-white"
      value={progress}
      min={0}
      max={100}
      step={0.1}
